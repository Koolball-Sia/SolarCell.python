...
class DataProcessor:
     ...
     #     data_processor.data_plotter.plot()
...
class NewData:
      ...
      def predictNew(self, data_processor):
          ...
          predicted_V = round(data_processor.model_V.predict(X_new)[0], 2)
          predicted_I = round(data_processor.model_I.predict(X_new)[0], 2)
          predicted_P = round(data_processor.model_P.predict(X_new)[0], 2)
...
SHEET_NAME_1 = "dust_data1" 
SHEET_NAME_2 = "time_data"
